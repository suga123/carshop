	...
	<div class="main">
		...
		<section class="container content clearfix">
			...
			<hgroup>
				...
				<h3 class="section-title">Column Layout</h3>
				<h6>Full Width</h6>
			...
			<div class="eleven columns alpha">
				...
				<h6>Three Thirds Columns</h6>
				
				<p>
					Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
					Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
					consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat
					nulla pariatur. Consectetur adipisicing elit.
				</p>
			...
			<div class="five columns omega">
				...
				<h6>One third column</h6>
				
				<p>Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua  in voluptate velit esse cillum dolore.</p>
			...
			<div class="four columns alpha">
				...
				<h6>Three Fourth Columns</h6>
				
				<p>
					Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
					Ut enim ad minim veniam, quis nostrud sed.
				</p>			
